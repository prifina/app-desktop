...
import { listNotifications, listNotificationsByDate } from "../graphql/queries";
import data from "@iconify/icons-bx/bx-search-alt-2";
...
const UserMenuContextProvider = ({
  ...
  const notificationList = async () => {
    const notifications = await clientHandler.query({
