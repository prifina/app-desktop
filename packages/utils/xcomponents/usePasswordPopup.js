...
const PopupContainer = styled.div`
  ...
  background-color: ${props =>
    props.backGroundColor || props.theme.colors.baseWhite}; // #f5f8f7;  from theme
  width: 371px;
...
const Popup = ({ floating, strategy, x, y, arrowRef, arrowX, backGroundColor = null, className, verifications, ...props }) => {
...
#password-arrow {
  ...
  &:after {
    content: " ";
    position: absolute;
    top: 13px; // we account for the PopperContainer padding
    left: 0;
    transform: rotate(225deg);
    width: 20px;
    height: 20px;
    background-color: ${props => props.backGroundColor || props.theme.colors.baseWhite}; // from theme
