...
import { Box, Flex, Button, Text, Checkbox, useTheme } from "@blend-ui/core";
...
margin-top:20px;
`;
const TermsOfUse = ({ texts, termsLastUpdated, backGroundColor, declineTerms, approveTerms }) => {
...
*/
  ...
  return (
    <TermsContainer bg={backGroundColor}>
      {decline && (
      ...
      */}
      ...
      <Flex mt={10} mb={12}>
        <Checkbox checked={scrolled} onChange={() => setScrolled(preValue => !preValue)}>
...
TermsOfUse.propTypes = {
  ...
  termsLastUpdated: PropTypes.string,
