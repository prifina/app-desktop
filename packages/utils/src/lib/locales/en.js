const strings = {
  en: {
    ...
    applyToPublishApps: "Apply to apps",
    dashboard: "Dashboard",
    projects: "Projects",
    resources: "Resources",
    ...
    devMiscellaneousText:
      ...
      // Dev-console terms
      // components 
      devComponentSidebarTitle: "Developer Account",
      devComponentProductImageTitle: "Product Image",
      devComponentProductImageText: "Add images which represent key elements of your product experience.",
      productImageHelpText: "Images should be .jpg or .PNG and high enough resolution to display @ 284x213px on retina displays.",
      devComponentErrorScreenTitle: "ERROR MESSAGE",
      devComponentErrorScreenHeader: "Oops! Something went wrong.",
      devComponentErrorScreenText: "There is a problem with the remote link you entered.",
      devComponentErrorScreenTextBody: "This could either be a problem with the link itself or an error with your build. We cannot provide an exact error but here are some solutions to common problems.",
      devComponentHelperText: "USER HELD",

      devComponentResourcesTitle: "Getting started",
      devComponentResourcesHeader: "Read our quick start guide to familiarize yourself with Prifina’s tools and workflows!",
      buildResourcesTabText: "Build resources",
      testResourcesTabText: "Test resources",
      testSettingsTabText: "Settings",
      settingsHelperText: "Generate inputs used in your project (json format)",
      devComponentSystemSandboxTitle: "Tell us what settings are included with your project. Changes here will be saved to your project package.",
      devComponentSystemSandboxText: "Widget sizes",
      devComponentSystemSandboxSize1: "300x300",
      devComponentSystemSandboxSize2: "600x300",
      devComponentSystemSandboxSize3: "300x600",
      devComponentSystemSandboxSize4: "600x600",
      devComponentSystemSandboxThemes: "Project Themes",
      devComponentSystemSandboxThemes1: "Light",
      devComponentSystemSandboxThemes2: "Dark",
      devComponentUploadAppText: "Upload zip file",
      devComponentUploadFileTextDrop: "Release to drop",
      devComponentUploadFileTextBuild: "Upload a .zip file of your build", 
      devComponentUploadFileProgress: "Progress: ",
      unsavedChangesSectionStatusText: "Unsaved changes",
      noUnsavedChangesSectionStatusText: "No Unsaved changes",
      devComponentProjectDetailsRemoteLinkTest: "Remote Link Test",
      devComponentProjectDetailsRemoteLinkTestDesc: "Link your local build to your Prifina's testing enviroment and dymamic data connectors by adding a remote link below",
      devComponentProjectDetailsInputText: "Links your local build to the App Studio",
      devComponentProjectDetailsTextPackage: "Application packages",
      devComponentProjectDetailsAppDesc: "   To get your application published in our App Market, you will need to supply the Prifina team a .Zip build deployment package, manifest file, UI inputs and settings as-well-as any native assets. For more information visit our documentation",
      devComponentProjectDetailsAppDesc2: " After you submit everything your application will be reviewed by our App Market team.",
      subSectionHeadingBuildDeployment: "1.Build deployment",
      subSectionForBuildDeployment: "Upload a packaged version of your application.",
      versionNumberForLabel: "Version number",
      versionNumberForLabelHelp1: "This version number if for your internal use.",
      versionNumberForLabelHelp2: "Formatting must follow semantic versioning format",
      appIdFormLabel: "App ID",
      appIDHelperText: "Unique project identifier. Add this to your build deployment package.",
      docLabel: "Visit our docs for more information",
      packageUploaderFormLabel: "Build deployment package",
      buildDeploymentPackageRuleText: "The build deployment package is a packages version of your local build. It must include:",
      buildDeploymentPackageRule1: "Your prifina App ID (as the filename)", 
      buildDeploymentPackageRule2: "Your prifina ID (in the codebase)",
      statusHelperText: "Status",
      sectionHeadingMarkeplaceListing: "Marketplace listing",
      marketplaceListingDecs: "All applications published on our platform have a listing page in the Prifina App Marketplace. This is what users will see when they are deciding wether or not to install your app",
      marketPlaceLisitngText: "For context you can visit the App Marketplace and see how this information will be displayed.",
      subSectionHeadingPublisherDetails: "1.Publisher Details",
      subSectionHeadingCategorization: "2.Categorization and Support",
      subSectionHeadingAppData: "3.App Data",
      subSectionHeadingProduct: "4.Product description",
      subSectionHeadingMarketing: "5.Marketing assest",
      subSectionForPublisherDetails: "The name users will see associated with all your applications in the App Marketplace.",
      subSectionForHeading:"Add descriptions of your product and list it's features. This information will be shown under the 'details' tab of your product page.",
      subSectionForMarketing: "Add your App icon and screenshots for your marketplace listing.",
      publisherNameLabel: "Publisher name",
      subSectionForPublisherTextHelp: "Packaged version of your application, including manifest file.",
      langSupLabel: "Language support",
      langSupportHelpText: "Prifina only currently supports English but we have plans to add other languages soon!",
      deviceSupLabel: "Device support",
      deviceSupHelpText: "Prifina only currently supports desktop but we have plans to add other devices soon!",
      appCatLabel: "Application category (select 1)",
      appCatHelpText1: "Select the category that best describes your application.",
      appCatHelpText2: "if none fit choose 'Other'",
      appIconHeading: "App Icon",
      appIconText: "Add a unique icon which represents your product experience.",
      appIconHelpText: "Images should be .jpg or .PNG and high enough resolution to display @ 56x56px on retina displays.",
      ageAppropLabel: "Age appropriate (select 1)",
      ageAppropHelpText: "Select the appropriate age your product.",
      subSectionForAppData1: "Tell your user what specific data your application requires or generates. This information will be under the 'data requirements' tab in your product page.",
      subSectionForAppData2: "For more detail on data type and detailing data use visit our docs.",
      subSectionForNaviteAssets: "If your application requires any addtional assets to keep it lightweight consider using native assets rather than having them in the build deployment package.",
      publicLabel: "Public data",
      publicHelpText1: " Detail any attributes your application uses from public data sources. For example “Open weather API”.",
      publicHelpText2: "For more examples of public data visit our documentation.",
      userHeldHelpText1: "Detail any attributes your application uses from user via our data connectors. For example from the 'Oura' data connector you migth have 'Deep sleep'.",
      userHeldHelpText2: "For more examples of user-held data visit our documentation.",
      userGenerateHelpText1: "User Generated",
      userGenerateHelpText2: "This name will be associeted with your product on the App Marketplace.",
      userAppMarketplaceText1: "The name will see on the App Marketplace.",
      userAppMarketplaceText2: "The application name is also your project name in the App Studio.",
      applicationNameLabel: "Application name",
      shortDescriptionLabel: "Short description",
      shortDescriptionText1: "Aconcise description of your product.",
      shortDescriptionText2: " This will be used standalone on the widget directory page and along with the long description in your marketplace listing page.",
      wordDescriptionLength: "Max 50 words",
      longDescriptionLabel: "Long description",
      longDescriptionText1: "Go into more detail about your product and the value it offers to users.",
      longDescriptionText2: "This will be used along with the short description on your product's listing page. You can treat the short description as an introduction and the long as more details.",
      featuresListLabel: "Features list",
      featuresListHelpText1: "Type to add features, these will be translated into a simple numbered list.",
      featuresListHelpText2: "The order you enter features in here will be the order reflected in your product's listing page.",
      productImagesHeader: "Product Images",
      productImagesHelpText1: "Upload three screenshots of key screens in your application. Images should be 284 x 214px and high resolution.",
      productImagesHelpText2: "These screenshots will be in your product's App Marketplace listing page. Images will be shown top-to-bottom based of the numerical order below.",
      productImagesHelpText3: "For guidelines on creating acceptable images visit our documentation",
      dataResourcesSurveyLabel: "Data Resources survey (optional)",
      dataResourceshelpPara: "Let us know how your application uses data by logging your sources (or lack of) here. This information helps us provide quality support and helps direct our product roadmap.",
      publicDataSourcesText1: "Search for public data sources in our list or add them if they are not there yet.",
      publicDataSourcesText2: "This information helps us provide quality support and helps direct our product roadmap.",
      publishProjectHeading: "PUBLISH PROJECT",
      appStatusLabel : "Your app Status is -",
      deleteProjectLabel: "DELETE PROJECT",
      deleteProjectHelpText: "Choose this to delete your project and all data associated with your account. This operation is final and all data will be permanently lost.",
      loadingLabel: "Loading...",
      loginAccountText: "Login to your account",
      ...
      existingAccCalloutHeader: "Already have a Prifina account?",
      existingAccCalloutText: "Use the same credentials to log in here",
      sandboxAnnouncementBannerText: "This is a live Sandbox session you are seeing how your project will render on Prifina",
      sandboxLabel: "Sandbox",
      sessionStatusText: "Session Status",
      remoteLinkUnavailable: "Remote link unavailable",
      testSettingstabText: "Test settings",
      systemSettingsTabText: "System settings",
      debuggerTabText: "Debugger",
      nativeAssestsTabText: "Native assets",
      settingTabText: "Settings",
      supportTabText: "Support",
      prifinaProjectUniqueText: "Unique Prifina project identifier",
      noValidRemoteLinkText: "Your remote link is not valid",
      existingRemoteLinkText: "This remote link already exists",
      buildRemoteLinkText: "Links to your build",
      nativeAssetsUploaderHelperText1: "Upload native assets for use in your project. Test them out in sandbox mode before packaging up in you application package.",
      nativeAssetsUploaderHelperText2: "For more information on using native assets visit our documentation",
